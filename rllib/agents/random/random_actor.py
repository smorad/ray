...
from ray.rllib.agents.random.default_config import DEFAULT_CONFIG
from ray.rllib.agents.random.pg_tf_policy import PGTFPolicy
from ray.rllib.agents.random.pg_torch_policy import PGTorchPolicy
from ray.rllib.policy.policy import Policy
from ray.rllib.utils.annotations import override
from ray.rllib.utils.typing import TrainerConfigDict


class RandomActorTrainer(Trainer):
    ...
    def get_default_policy_class(self, config) -> Type[Policy]:
        return RandomActorTorchPolicy if config.get("framework") == "torch" else RandomActorTFPolicy
